...
class ReportDownloader:
    ...
    def run(self):
        def download(playwright: Playwright):
            ...
            download_path = r"Z:\CRMhorahora\Todas"
            ...
            page.get_by_role("textbox", name="Enter Email Address...").fill("GP002")
            page.wait_for_timeout(3000)
            page.get_by_role("textbox", name="Password").fill("miguelGP002")
            page.wait_for_timeout(3000)
            ...
            page.wait_for_timeout(3000)
            page.locator("#selectFirma").press("T")
            page.wait_for_timeout(3000)
